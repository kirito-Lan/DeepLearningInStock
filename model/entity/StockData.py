...
class StockData(ormar.Model):
    ...
    open_price: Decimal = ormar.Decimal(max_digits=10,decimal_places=3,nullable=True,comment="开盘价")
    close_price: Decimal = ormar.Decimal(max_digits=10,decimal_places=3,nullable=True,comment="收盘价")
    high_price: Decimal = ormar.Decimal(max_digits=10,decimal_places=3,nullable=True,comment="最高价")
    low_price: Decimal = ormar.Decimal(max_digits=10,decimal_places=3,nullable=True,comment="最低价")
    volume: int = ormar.Integer(nullable=True,comment="成交量（单位: 手）")
    turnover_amount: Decimal = ormar.Decimal(max_digits=15,decimal_places=3,nullable=True,comment="成交额（单位: 元）")
